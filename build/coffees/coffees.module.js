...
var DevelopmentConfigService = /** @class */ (function () {
    function DevelopmentConfigService() {
    }
    return DevelopmentConfigService;
}());
var ProductionConfigService = /** @class */ (function () {
    function ProductionConfigService() {
    }
        ...
        (0, common_1.Module)({
            ...
            providers: [
                ...
                },
                {
                    ...
                    useFactory: function (connection) { return __awaiter(void 0, void 0, void 0, function () {
                        var coffeeBrands;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, Promise.resolve(['buddy brew', 'nescafe'])];
                                case 1:
                                    coffeeBrands = _a.sent();
                                    console.log('[!] Async factory');
                                    return [2 /*return*/, coffeeBrands];
                            }
                        });
                    }); },
            ...
            exports: [_coffees_service_1.CoffeesService],
        })
    ], CoffeesModule);
